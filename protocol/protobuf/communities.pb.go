...
type CommunityDescription struct {
	...
	MagnetlinkClock      uint64                        `protobuf:"varint,9,opt,name=magnetlink_clock,json=magnetlinkClock,proto3" json:"magnetlink_clock,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                      `json:"-"`
	XXX_unrecognized     []byte                        `json:"-"`
	XXX_sizecache        int32                         `json:"-"`
}
...
func (m *CommunityDescription) GetMagnetlinkClock() uint64 {
	if m != nil {
		return m.MagnetlinkClock
	}
	return 0
}
...
var fileDescriptor_f937943d74c1cd8b = []byte{
	...
	,
}
